...
<head>
    ...
    <title>Restaurant Legends Tropical</title>
    ...
    <div id="fh5co-page">
        ...
        <header id="fh5co-header" role="banner">
            <div class="container">
                ...
                <a href="index.php" id="fh5co-header-logo"><img src="images/logo.png" width="200px" alt="LEAGUE TROPICAL Logo"></a>
                <a href="#" class="fh5co-header-bars js-nav-toggle"><span>Menu</span> <i class="ti-menu"></i></a>

                <h1 class="fh5co-header-intro">El sabor de la sonrisa</h1>
            </div>
        </header>
        <!-- /fh5co-header -->